...
/**
 * @Author: sy
 * @Date: Created by 2021/10/13 11:13
 * @description:
 */
@Slf4j
@Component
public class HBaseClient {
    ...
    private void init() {
        ...
        try {
            ...
            log.error("HBase 连接异常: {}", e.getMessage());
        }
    }
     ...
     * @return
     */
    public Map<String,Object> selectOneRowDataMap(String tableName, String rowNumber) throws IOException {
